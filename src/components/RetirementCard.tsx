...
const RetirementCard = () => {
  ...
  const generateAIAnalysis = () => {
    ...
    text += `💰 Total assets available: $1,100,000\n`;
  ...
  const formatCurrency = (value: number) => {
    if (value >= 999500) { // Use 999.5K as threshold to round to 1M
      ...
      <Card className="relative overflow-hidden h-full flex flex-col">
        ...
        <CardContent className="flex-1 flex flex-col space-y-6">
          ...
          <div className="text-center p-5 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-100">
            <p className="text-4xl font-bold text-purple-600 mb-2">{formatCurrency(1100000)}</p>
